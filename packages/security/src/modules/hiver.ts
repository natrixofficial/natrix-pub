...
import type { KeyPair } from "./hiver.types";

import { Hasher } from "./hasher";
import { BLS, Id, SecretKey, PublicKey, Signature, Fr } from "./bls-helper";

class HiverTypeGuards {
	public static sigVecIsHexString(members: HexString[] | Buffer[] | Uint8Array[] | Signature[] | unknown[]): members is HexString[] {
	...
	public static sigVecIsBuffer(members: HexString[] | Buffer[] | Uint8Array[] | Signature[] | unknown[]): members is Buffer[] {
		if (!Array.isArray(members)) {
			return false;
		}
	...
	public static sigVecIsUint8Array(members: HexString[] | Buffer[] | Uint8Array[] | Signature[] | unknown[]): members is Uint8Array[] {
		if (!Array.isArray(members)) {
			return false;
		}
	...
	public static sigVecIsNative(members: HexString[] | Buffer[] | Uint8Array[] | Signature[] | unknown[]): members is Signature[] {
		if (!Array.isArray(members)) {
			return false;
		}
	...
	public static idVecIsHexString(members: HexString[] | Buffer[] | Uint8Array[] | Id[] | unknown[]): members is HexString[] {
		if (!Array.isArray(members)) {
			return false;
		}
		if (members.some((item) => typeof item !== "string")) {
	...
	public static idVecIsBuffer(members: HexString[] | Buffer[] | Uint8Array[] | Id[] | unknown[]): members is Buffer[] {
		if (!Array.isArray(members)) {
			return false;
		}
		if (members.some((item) => !(item instanceof Buffer))) {
	...
	public static idVecIsUint8Array(members: HexString[] | Buffer[] | Uint8Array[] | Id[] | unknown[]): members is Uint8Array[] {
		if (!Array.isArray(members)) {
			return false;
		}
		if (members.some((item) => !(item instanceof Uint8Array))) {
	...
	public static idVecIsNative(members: HexString[] | Buffer[] | Uint8Array[] | Id[] | unknown[]): members is Id[] {
		if (!Array.isArray(members)) {
			return false;
		}
...
export class Hiver {
	...
	public static toHex(data: unknown): unknown {
		if (data instanceof Id || data instanceof SecretKey || data instanceof PublicKey || data instanceof Signature) {
	...
	public static sign(data: object, dataEncoding: BufferEncoding, secretKey: HexString): Signature;
	public static sign(data: object, dataEncoding: BufferEncoding, secretKey: Uint8Array): Signature;
	public static sign(data: object, dataEncoding: BufferEncoding, secretKey: Buffer): Signature;
	public static sign(data: object, dataEncoding: BufferEncoding, secretKey: SecretKey): Signature;
	public static sign(data: string, dataEncoding: BufferEncoding, secretKey: HexString): Signature;
	public static sign(data: string, dataEncoding: BufferEncoding, secretKey: Buffer): Signature;
	public static sign(data: string, dataEncoding: BufferEncoding, secretKey: Uint8Array): Signature;
	public static sign(data: string, dataEncoding: BufferEncoding, secretKey: SecretKey): Signature;
	public static sign(data: unknown, dataEncoding: BufferEncoding, secretKey: unknown): Signature {
		const dataStr = typeof data !== "string" ? Hasher.stringify(data as object) : data;
	...
	public static signHash(hash: string, hashEncoding: BufferEncoding, secretKey: HexString): Signature;
	public static signHash(hash: string, hashEncoding: BufferEncoding, secretKey: Buffer): Signature;
	public static signHash(hash: string, hashEncoding: BufferEncoding, secretKey: Uint8Array): Signature;
	public static signHash(hash: string, hashEncoding: BufferEncoding, secretKey: SecretKey): Signature;
	public static signHash(hash: string, hashEncoding: BufferEncoding, secretKey: unknown): Signature {
		if (typeof secretKey === "string") {
			const secretKeyTemp = new SecretKey();
			secretKeyTemp.deserializeHexStr(secretKey);
			return secretKeyTemp.sign(new Uint8Array(Buffer.from(hash, hashEncoding)));
		}
		if (secretKey instanceof Buffer) {
			const secretKeyTemp = new SecretKey();
			secretKeyTemp.deserialize(new Uint8Array(secretKey));
	...
	public static verifyBuffer(data: Buffer, publicKey: HexString, signature: HexString): boolean;
	public static verifyBuffer(data: Buffer, publicKey: Buffer, signature: Buffer): boolean;
	public static verifyBuffer(data: Buffer, publicKey: Uint8Array, signature: Uint8Array): boolean;
	public static verifyBuffer(data: Buffer, publicKey: PublicKey, signature: Signature): boolean;
	public static verifyBuffer(data: Buffer, publicKey: unknown, signature: unknown): boolean {
	...
	public static verifyHex(data: HexString, publicKey: HexString, signature: HexString): boolean;
	public static verifyHex(data: HexString, publicKey: Buffer, signature: Buffer): boolean;
	public static verifyHex(data: HexString, publicKey: Uint8Array, signature: Uint8Array): boolean;
	public static verifyHex(data: HexString, publicKey: PublicKey, signature: Signature): boolean;
	public static verifyHex(data: HexString, publicKey: unknown, signature: unknown): boolean {
		if (typeof publicKey === "string" && typeof signature === "string") {
			const publicKeyTemp = BLS.deserializeHexStrToPublicKey(publicKey);
			const signatureTemp = BLS.deserializeHexStrToSignature(signature);
			const hash = Hasher.sha512Buffer(Buffer.from(data, "hex"));
	...
	public static verify(data: Record<string, unknown>, dataEncoding: BufferEncoding, publicKey: HexString, signature: HexString): boolean;
	public static verify(data: Record<string, unknown>, dataEncoding: BufferEncoding, publicKey: Buffer, signature: Buffer): boolean;
	...
	public static verify(data: Record<string, unknown>, dataEncoding: BufferEncoding, publicKey: PublicKey, signature: Signature): boolean;
	public static verify(data: string, dataEncoding: BufferEncoding, publicKey: HexString, signature: HexString): boolean;
	public static verify(data: string, dataEncoding: BufferEncoding, publicKey: Buffer, signature: Buffer): boolean;
	public static verify(data: string, dataEncoding: BufferEncoding, publicKey: Uint8Array, signature: Uint8Array): boolean;
	public static verify(data: string, dataEncoding: BufferEncoding, publicKey: PublicKey, signature: Signature): boolean;
	public static verify(data: unknown, dataEncoding: BufferEncoding, publicKey: unknown, signature: unknown): boolean {
		const dataStr = typeof data !== "string" ? Hasher.stringify(data as object) : data;
	...
	public static verifyHashBuffer(hash: Buffer, publicKey: HexString, signature: HexString): boolean;
	public static verifyHashBuffer(hash: Buffer, publicKey: Buffer, signature: Buffer): boolean;
	public static verifyHashBuffer(hash: Buffer, publicKey: Uint8Array, signature: Uint8Array): boolean;
	public static verifyHashBuffer(hash: Buffer, publicKey: PublicKey, signature: Signature): boolean;
	public static verifyHashBuffer(hash: Buffer, publicKey: unknown, signature: unknown): boolean {
		if (typeof publicKey === "string" && typeof signature === "string") {
			const publicKeyTemp = BLS.deserializeHexStrToPublicKey(publicKey);
			const signatureTemp = BLS.deserializeHexStrToSignature(signature);
			return publicKeyTemp.verify(signatureTemp, new Uint8Array(hash));
	...
	public static verifyHashHex(hash: HexString, publicKey: HexString, signature: HexString): boolean;
	public static verifyHashHex(hash: HexString, publicKey: Buffer, signature: Buffer): boolean;
	public static verifyHashHex(hash: HexString, publicKey: Uint8Array, signature: Uint8Array): boolean;
	public static verifyHashHex(hash: HexString, publicKey: PublicKey, signature: Signature): boolean;
	public static verifyHashHex(hash: HexString, publicKey: unknown, signature: unknown): boolean {
		if (typeof publicKey === "string" && typeof signature === "string") {
			const publicKeyTemp = BLS.deserializeHexStrToPublicKey(publicKey);
			const signatureTemp = BLS.deserializeHexStrToSignature(signature);
			return publicKeyTemp.verify(signatureTemp, new Uint8Array(Buffer.from(hash, "hex")));
		}
		if (publicKey instanceof Buffer && signature instanceof Buffer) {
			const publicKeyTemp = new PublicKey();
			publicKeyTemp.deserialize(new Uint8Array(publicKey));
		...
		if (publicKey instanceof PublicKey && signature instanceof Signature) {
			return publicKey.verify(signature, new Uint8Array(Buffer.from(hash, "hex")));
		}
		throw new Error("verify:mismatch type");
	}

	public static verifyHash(hash: string, dataEncoding: BufferEncoding, publicKey: HexString, signature: HexString): boolean;
	public static verifyHash(hash: string, dataEncoding: BufferEncoding, publicKey: Buffer, signature: Buffer): boolean;
	public static verifyHash(hash: string, dataEncoding: BufferEncoding, publicKey: Uint8Array, signature: Uint8Array): boolean;
	public static verifyHash(hash: string, dataEncoding: BufferEncoding, publicKey: PublicKey, signature: Signature): boolean;
	public static verifyHash(hash: string, dataEncoding: BufferEncoding, publicKey: unknown, signature: unknown): boolean {
		if (typeof publicKey === "string" && typeof signature === "string") {
			const publicKeyTemp = BLS.deserializeHexStrToPublicKey(publicKey);
			const signatureTemp = BLS.deserializeHexStrToSignature(signature);
			return publicKeyTemp.verify(signatureTemp, new Uint8Array(Buffer.from(hash, dataEncoding)));
		}
		if (publicKey instanceof Buffer && signature instanceof Buffer) {
			const publicKeyTemp = new PublicKey();
			publicKeyTemp.deserialize(new Uint8Array(publicKey));
		...
		if (publicKey instanceof PublicKey && signature instanceof Signature) {
			return publicKey.verify(signature, new Uint8Array(Buffer.from(hash, dataEncoding)));
		}
		throw new Error("verify:mismatch type");
	}
	...
	public static recoverSign(sigVec: Uint8Array[], idVec: Uint8Array[]): Signature;
	...
	public static recoverSign(sigVec: unknown[], idVec: unknown[]): Signature {
		if (HiverTypeGuards.sigVecIsHexString(sigVec) && HiverTypeGuards.idVecIsHexString(idVec)) {
			const a = new Signature();
			const sigVecTemp = sigVec.map((item) => BLS.deserializeHexStrToSignature(item));
			const idVecTemp = sigVec.map((item) => BLS.deserializeHexStrToId(item));
			a.recover(sigVecTemp, idVecTemp);
			return a;
		}
		if (HiverTypeGuards.sigVecIsBuffer(sigVec) && HiverTypeGuards.idVecIsBuffer(idVec)) {
			const a = new Signature();
		...
		if (HiverTypeGuards.sigVecIsUint8Array(sigVec) && HiverTypeGuards.idVecIsUint8Array(idVec)) {
			const a = new Signature();
			const sigVecTemp = sigVec.map((item) => {
				const sig = new Signature();
		...
		if (HiverTypeGuards.sigVecIsNative(sigVec) && HiverTypeGuards.idVecIsNative(idVec)) {
			const a = new Signature();
