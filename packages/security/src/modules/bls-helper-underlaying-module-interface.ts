...
export interface IUnderlayingModule {
	...
	_mclBnFr_getStr: (x: number, ioMode?: number | undefined) => string | Uint8Array; //_wrapGetStr
	...
	_mclBnG1_getStr: (x: number, ioMode?: number | undefined) => string | Uint8Array; //_wrapGetStr;
	...
	_mclBnG2_getStr: (x: number, ioMode?: number | undefined) => string | Uint8Array; //_wrapGetStr;
	...
	_mclBnGT_isZero: any;
	_mclBnGT_isOne: any;
	_mclBnGT_getStr: (x: number, ioMode?: number | undefined) => string | Uint8Array; //_wrapGetStr;
	...
	_mclBnG1_mulVec: (resultG1Pos: number, G1ArrayPos: number, FRArrayPos: number) => void;
	_mclBnG2_mulVec: (resultG2Pos: number, G2ArrayPos: number, FRArrayPos: number) => void;
	_mclBnGT_powVec: any;
	_mclBn_pairing: (resultGTPos: number, g1Pos: number, g2Pos: number) => void;
	_mclBn_finalExp: (resultPos: number, xPos: number) => void;
	_mclBn_millerLoop: (resultGTPos: number, g1Pos: number, g2Pos: number) => void;
	_mclBn_millerLoopVec: any;
	_mclBn_getUint64NumToPrecompute: any;
	_mclBn_precomputeG2: any;
	_mclBn_precomputedMillerLoop: (resultPos: number, PPos: number, Qcoeff: number) => void;
	_mclBn_precomputedMillerLoop2: (resultPos: number, P1Pos: number, Q1coeff: number, P2Pos: number, Q2coeff: number) => void;
	_mclBn_precomputedMillerLoop2mixed: (resultPos: number, P1Pos: number, Q1Pos: number, P2Pos: number, Q2coeff: number) => void;
	...
	_mclBnFp_getStr: (x: number, ioMode?: number | undefined) => string | Uint8Array; //_wrapGetStr;
	...
	_blsDHKeyExchange: (resultPubKeyPos: number, secKeyPos: number, pubKeyPos: number) => void;
